...
#include "AICtrl_Processor.generated.h"

/**
 * 
 */
UCLASS()
class TCC_API AAICtrl_Processor : public AAIController
{
	GENERATED_BODY()
	...
	AAICtrl_Processor(const class FObjectInitializer& ObjectInitializer);
